"""backend_test_5 URL Configuration
...
admin.site.site_header = "Backend test"
admin.site.site_title = "Backend test Admin Portal"
admin.site.index_title = "Backend test Admin"
